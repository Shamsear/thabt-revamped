...
export const Footer: React.FC<FooterProps> = ({ lang: propLang }) => {
  ...
  return (
    <>
      ...
      {/* WhatsApp Concierge floating button (z-30, dynamically coordinated with mobile bottom nav) */}
      <div
        className={`fixed right-5 rtl:right-auto rtl:left-5 z-30 transition-all duration-300 ease-out ${floatingBottomClass}`}
      >
        <a
          href={whatsappHref}
          target="_blank"
      ...
      {/* Back to Top / To Up Button (z-30, dynamically coordinated with mobile bottom nav) */}
      <button
        type="button"
        onClick={scrollToTop}
