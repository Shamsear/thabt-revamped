        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-3 sm:space-y-3.5">
            ...
            <div className="bg-neutral-50/90 border border-neutral-200/90 rounded-2xl p-3.5 sm:p-4.5 shadow-xs">
              {/* Tab Toggles with Animated Gold Sliding Indicator */}
              <div className="flex border-b border-neutral-200/80 mb-3 relative">
                <button
                  type="button"
                  onClick={() => setActiveTab("vehicle")}
                  className={`pb-2 px-3 sm:px-4 text-xs sm:text-sm tracking-wide font-medium transition duration-150 relative cursor-pointer ${
                    activeTab === "vehicle"
              ...
              {activeTab === "vehicle" && (
                <form onSubmit={handleSearchSubmit} className="space-y-2.5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full appearance-none bg-white text-neutral-900 text-xs sm:text-sm rounded-lg px-3 py-2 sm:py-2.5 border border-neutral-200 focus:border-[#c5a059] focus:outline-none transition cursor-pointer"
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full appearance-none bg-white text-neutral-900 text-xs sm:text-sm rounded-lg px-3 py-2 sm:py-2.5 border border-neutral-200 focus:border-[#c5a059] focus:outline-none transition cursor-pointer disabled:bg-neutral-100 disabled:text-neutral-400"
                        >
                          <option value="" disabled>
                  ...
                  <div className="pt-1">
                    <button
                      type="submit"
                      className="w-full py-2.5 sm:py-3 px-5 rounded-lg bg-[#c5a059] hover:bg-[#b38e46] text-neutral-950 text-xs uppercase tracking-widest font-bold transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 shadow-xs hover:shadow-[0_6px_24px_rgba(197,160,89,0.3)] active-press group"
                    >
                      <span>
                        {lang === "ar"
            ...
            <div className="relative rounded-2xl overflow-hidden bg-neutral-100 border border-neutral-200/80 shadow-md group">
              <div className="relative h-[280px] sm:h-[330px] lg:h-[350px] xl:h-[390px] w-full overflow-hidden">
                <img
                  ...
                  className="w-full h-full object-cover object-bottom group-hover:scale-103 transition-transform duration-700 ease-out"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent pointer-events-none" />
              </div>

              {/* Inset Technical Note Card - Dynamically Synced with Smooth Fade */}
              <motion.div
                key={activeTab === "vehicle" ? `${selectedVehicleBrand}-${selectedVehicleModel}` : `${selectedDeviceBrand}-${selectedDeviceModel}`}
                initial={{ opacity: 0.6, y: 6 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.25, ease: "easeOut" }}
                className="absolute bottom-2.5 sm:bottom-3 left-2.5 sm:left-3 right-2.5 sm:right-3 p-3 sm:p-3.5 rounded-xl bg-white/95 backdrop-blur-md border border-neutral-200/80 text-neutral-900 shadow-sm transition-all duration-200"
              >
