...
export const FaqSection: React.FC<FaqSectionProps> = ({ faqs, lang }) => {
  ...
  return (
    <section className="py-8 sm:py-16 lg:py-20 bg-white text-neutral-900 border-b border-neutral-100 overflow-hidden">
      <div className="max-w-4xl mx-auto px-3 sm:px-8">
        ...
        >
          {/* Section Header */}
          <motion.div variants={fadeUpItemVariants} className="mb-5 sm:mb-10">
          ...
          <div className="divide-y divide-neutral-200/70">
            {faqs.map((faq) => {
              ...
              return (
                <motion.div key={faq.id} variants={fadeUpItemVariants} className="py-3 sm:py-5">
                  <button
                    type="button"
