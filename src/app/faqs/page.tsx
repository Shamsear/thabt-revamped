      ...
      <main className="flex-1 py-8 sm:py-14">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 space-y-10 sm:space-y-12">
          ...
          >
            ...
            {/* Heading */}
            <motion.div variants={fadeUpItemVariants} className="text-center max-w-xl mx-auto mb-8">
            ...
            <motion.div variants={fadeUpItemVariants} className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
          ...
          {/* Accordion FAQ List - Independent Viewport Observer */}
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={viewportOnce}
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="divide-y divide-neutral-200/70 border-y border-neutral-200/70"
              >
          ...
          {/* WhatsApp Concierge Card - Independent Viewport Observer */}
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={viewportOnce}
            variants={fadeUpItemVariants}
            className="bg-neutral-50 rounded-2xl border border-neutral-200/80 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6"
          >
