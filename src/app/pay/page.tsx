  ...
  return (
    <div className={`min-h-screen bg-neutral-50 text-neutral-900 ${lang === "ar" ? "rtl" : "ltr"}`} dir={lang === "ar" ? "rtl" : "ltr"}>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
        ...
        <div className="mb-6 p-4 rounded-2xl bg-amber-50 border border-amber-200/80 flex items-start gap-3 text-xs text-amber-900">
          <Sparkles size={18} className="text-amber-600 shrink-0 mt-0.5" />
          <div>
            <p className="font-bold">
              {lang === "ar"
                ? "واجهة توضيحية أمامية (Frontend Mock Mode):"
                : "Interactive Frontend Prototype Mode:"}
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <button
                ...
                className={`p-3 rounded-xl border text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-1.5 ${
                  paymentMethod === "card"
                    ? "bg-[#faf6ed] border-[#c5a059] text-[#9b7832] font-bold shadow-xs"
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-xs">
                ...
                <form onSubmit={handleSimulatePayment} className="space-y-4">
                  <div className="flex items-center justify-between pb-2 border-b border-neutral-100">
                    ...
                    <button
                      ...
                      className="text-[11px] font-bold text-[#9b7832] bg-[#faf6ed] px-2.5 py-1 rounded-lg border border-[#c5a059]/30 hover:bg-[#f4ebe0] cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-neutral-50 border border-neutral-200 rounded-xl px-3.5 py-2.5 text-xs font-mono text-neutral-900 focus:outline-none focus:border-[#c5a059]"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-3.5 px-4 rounded-xl bg-neutral-950 hover:bg-neutral-800 text-white font-extrabold text-xs flex items-center justify-center gap-2 shadow-md transition-all active:scale-98 cursor-pointer disabled:opacity-70"
                  >
                    {isProcessing ? (
                      <>
              ...
              {paymentMethod === "qpay" && (
                <div className="space-y-4 text-center py-4">
                  ...
                  <button
                    ...
                    disabled={isProcessing}
                    className="w-full py-3.5 px-4 rounded-xl bg-blue-700 hover:bg-blue-800 text-white font-extrabold text-xs flex items-center justify-center gap-2 transition cursor-pointer"
                  >
                    {isProcessing ? (
              ...
              {paymentMethod === "apple" && (
                <div className="space-y-4 text-center py-4">
                  ...
                  <h4 className="text-sm font-bold text-neutral-900">Apple Pay 1-Click</h4>
                  ...
                  <button
                    ...
                    onClick={handleSimulatePayment}
                    disabled={isProcessing}
                    className="w-full py-3.5 px-4 rounded-xl bg-black hover:bg-neutral-900 text-white font-extrabold text-xs flex items-center justify-center gap-2 shadow-sm transition cursor-pointer"
                  >
                    {isProcessing ? (
                      <Loader2 size={16} className="animate-spin text-[#c5a059]" />
                    ) : (
              ...
              {paymentMethod === "cod" && (
                <div className="space-y-4 text-center py-4">
                  ...
                  <button
                    ...
                    onClick={handleSimulatePayment}
                    disabled={isProcessing}
                    className="w-full py-3.5 px-4 rounded-xl bg-neutral-950 hover:bg-neutral-800 text-white font-extrabold text-xs flex items-center justify-center gap-2 transition cursor-pointer"
                  >
                    {isProcessing ? (
                      <Loader2 size={16} className="animate-spin text-[#c5a059]" />
                    ) : (
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-xs">
              <h3 className="text-sm font-extrabold text-neutral-950 pb-3 border-b border-neutral-100">
                {lang === "ar" ? "المبلغ المستحق" : "Summary"}
              </h3>
