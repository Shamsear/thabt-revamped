        ...
        <section className="py-12 sm:py-20 bg-neutral-50/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-6">
              {/* Feature 1 */}
              <div className="p-4 sm:p-6 rounded-2xl bg-white border border-neutral-200/70 hover:border-neutral-900 transition-colors space-y-2.5 sm:space-y-3 shadow-2xs">
