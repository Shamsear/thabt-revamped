      ...
      <main className="flex-1 py-6 sm:py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-14">
            <div className="p-6 rounded-2xl bg-neutral-50/80 border border-neutral-200/70 space-y-2">
          ...
          <div className="bg-neutral-50 rounded-2xl border border-neutral-200/80 p-6 sm:p-8 text-center max-w-2xl mx-auto space-y-3">
